...
<section className="relative overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-6 py-24 md:py-32 text-center relative">
    ...
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent text-accent-foreground text-sm font-medium mb-6">
      <Heart className="w-4 h-4" /> Healthcare  Platform
    </div>
    ...
    <p className="text-lg md:text-xl text-muted-foreground mt-6 max-w-2xl mx-auto leading-relaxed">
      A healthcare management system designed to help hospitals manage patients,
      doctors, appointments, and medical records in an organized and efficient way.
    </p>

    <div className="flex items-center justify-center gap-4 mt-10">
      <Button size="lg" asChild>
        <Link to="/login">Login <ArrowRight className="w-4 h-4 ml-2" /></Link>
      </Button>
